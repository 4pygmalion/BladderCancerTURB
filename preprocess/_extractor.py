...
DATA_DIR = os.path.join(PREP_DIR, "data")
...
class RegexFeatureExtractor:
    ...
    def determine_label(self, text: str) -> str:
        ...
        # Firstly, scan for postivie result. 하나라도 있으면 Positive이기에
    ...
    def preprocess(self):
        ...
        # Read data
        reports = pd.read_csv(self.config["PATHOLOGY_REPORTS"])
        reports = reports[self.config["COLUMNS"]]
